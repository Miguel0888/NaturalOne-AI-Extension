...
/**
	...
	public void createPartControl(Composite parent) {
	    ...
	    // Log view creation for smoke test
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				AstExplorerView.this.fillContextMenu(manager);
			}
		});
	...
	private void makeActions() {
		action1 = new Action() {
	        @Override
	        public void run() {
	            PluginLog.info("Action 1 executed from AstExplorerView.");
	    ...
	    // ... action2 und doubleClickAction bleiben erst mal wie sie sind
		action2 = new Action() {
			public void run() {
